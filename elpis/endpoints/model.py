...
def results():
    ...
    try:
        train_per, valid_per = model.get_results()
        results = {"train_per": train_per, "valid_per": valid_per}
        print(results)
    except AttributeError as e:
        # Then we assume it was a Kaldi model. If Elpis is to support different
        # models, then this code to extract the WER should probably lie in the
        # model wrapper, not here.
        wer_lines = []
